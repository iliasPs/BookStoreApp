...
public class BookProvider extends ContentProvider {
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        String supName = values.getAsString(BookEntry.COLUMN_BOOK_SUPPLIER);
        String supPhone = values.getAsString(BookEntry.COLUMN_BOOK_SUPPLIER_PHONE);

        if (TextUtils.isEmpty(name)) {
            Toast.makeText(getContext(), R.string.enter_book_name, Toast.LENGTH_SHORT).show();
        ...
        if (price != null && price < 0) {
            Toast.makeText(getContext(), R.string.enter_book_price, Toast.LENGTH_SHORT).show();
